...
const doctors = [
   ...
   { name: "Jane Smith", email: "jan@example.com", location: "Los Angeles", department: "Neurology" },
...
export { appointments, data, diseaseData, doctorData, doctors, medicines, patientData, patients };
