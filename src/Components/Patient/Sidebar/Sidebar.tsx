...
import { IconHeartbeat, IconLayoutGrid, IconStethoscope, IconUser } from "@tabler/icons-react";
...
const links = [
   ...
   { name: "Appointment", url: "/patient/appointments", icon: <IconStethoscope stroke={1.5} /> },
   // { name: "Patients", url: "/patient/patients", icon: <IconMoodHeart stroke={1.5} /> },
